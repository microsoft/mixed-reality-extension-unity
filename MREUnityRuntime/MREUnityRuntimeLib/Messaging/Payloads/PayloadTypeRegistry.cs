...
namespace MixedRealityExtension.Messaging.Payloads
{
    ...
    [PayloadType(typeof(StartAnimation), "start-animation")]
    [PayloadType(typeof(StopAnimation), "stop-animation")]
    [PayloadType(typeof(ResetAnimation), "reset-animation")]
    [PayloadType(typeof(PauseAnimation), "pause-animation")]
    [PayloadType(typeof(ResumeAnimation), "resume-animation")]
